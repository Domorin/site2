...
export function CatImage(props: {
	...
	return (
		<div className="group relative">
			<div className="flex flex-col items-center absolute top-0 left-0 group-hover:opacity-0 opacity-100 transition-all duration-500">
			...
			<div className="flex flex-col items-center absolute top-0 left-0 group-hover:opacity-100 opacity-0 transition-all duration-500">
				<div
